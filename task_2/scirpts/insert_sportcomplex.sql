...
INSERT INTO kspo_trainer VALUES(1,'Èâàíîâ','Èâàí', 'Èâàíîâè÷', 89023617345, '04/05/2002', 1, 'ìîëîäîé òðåíåð');
INSERT INTO kspo_trainer VALUES(2,'Ïåòðîâ', 'Ôèëèìîí', '', 89023611223, '04/05/1967', 22, 'ñòàðûé òðåíåð');
INSERT INTO kspo_trainer VALUES(3,'Ñèäîðîâ', 'Ìèõàèë', 'Þðüåâè÷', 89063517399, '12/12/1997', 4, 'òîæå ìîëîäîé òðåíåð');
INSERT INTO kspo_trainer VALUES(4,'Èâàíîâà', 'Èîàííà', 'Èâàíîâíà', 89040000090, '01/01/2000', 2, 'ìîëîäàÿ òðåíåðêà');
INSERT INTO kspo_trainer VALUES(5,'Ñìèðíîâ', 'Àëåêñåé', '', 89023617341, '03/02/1986', 13, '');
INSERT INTO kspo_trainer VALUES(6,'Ôèëàòîâ', 'Äìèòðèé', 'Àëåêñàíäðîâè÷', 89023610930, '04/05/1998', 3, 'òðåòèé ìîëîäîé òðåíåð');
INSERT INTO kspo_trainer VALUES(7,'Óãàðåâ', 'Àëåêñàíäð', 'Àëåêñàíäðîâè÷', 79203980000, '11/11/1989', 10, 'ïðîñòî òðåíåð');
INSERT INTO kspo_trainer VALUES(8,'Êîøêèí', 'Ñåðãåé', 'Àëåêñååâè÷', 89143617345, '06/07/1994', 7, 'òðåíåð Êîøêèí');
INSERT INTO kspo_trainer VALUES(9,'Ñîáàêèí', 'Èâàí', 'ßíîâè÷', 89163617345, '12/10/2003', 0.5, 'òðåíåð Ñîáàêèí');
INSERT INTO kspo_trainer VALUES(10,'Ïòèöûí', 'Ìèõàèë', 'Ðàõìåòîâè÷', 892577777777, '01/05/1992', 9, 'òðåíåð Ïòèöûí');
...
--  data for the table equipment_accounting
...
-- data for the table room_accounting
...
--here I figured out the correct TIMESTAMP input
